...
abstract class AbstractClassMetadataExporterTest extends OrmTestCase
{
    ...
    public function testExportDirectoryAndFilesAreCreated()
    {
        ...
        self::assertEquals('Doctrine\Tests\ORM\Tools\Export\ExportedUser', $metadata[0]->name);
        ...
        if ($type == 'annotation') {
            self::assertTrue(file_exists(__DIR__ . '/export/' . $type . '/'.str_replace('\\', '/', 'Doctrine\Tests\ORM\Tools\Export\ExportedUser').$this->_extension));
        } else {
    ...
    public function testExportedMetadataCanBeReadBackIn()
    {
        ...
        self::assertEquals('Doctrine\Tests\ORM\Tools\Export\ExportedUser', $class->name);
    ...
    public function testTableIsExported($class)
    {
        ...
        self::assertEquals(array('engine' => 'MyISAM', 'foo' => array('bar' => 'baz')),
            $class->table['options']);
    ...
    public function testOneToOneAssociationsAreExported($class)
    {
        ...
        self::assertEquals('Doctrine\Tests\ORM\Tools\Export\Address', $class->associationMappings['address']['targetEntity']);
    ...
    public function testManyToOneAssociationsAreExported($class)
    {
        ...
        self::assertEquals('Doctrine\Tests\ORM\Tools\Export\Group', $class->associationMappings['mainGroup']['targetEntity']);
    }
    ...
    public function testOneToManyAssociationsAreExported($class)
    {
        ...
        self::assertEquals('Doctrine\Tests\ORM\Tools\Export\Phonenumber', $class->associationMappings['phonenumbers']['targetEntity']);
    ...
    public function testManyToManyAssociationsAreExported($class)
    {
        ...
        self::assertEquals('Doctrine\Tests\ORM\Tools\Export\Group', $class->associationMappings['groups']['targetEntity']);
