...
class EntityGeneratorTest extends OrmTestCase
{
    ...
    public function testGeneratedEntityClass()
    {
        ...
        self::assertInstanceOf('Doctrine\Common\Collections\ArrayCollection', $book->getComments());
        self::assertEquals(new ArrayCollection(array($comment)), $book->getComments());
        self::assertInternalType('boolean', $book->removeComment($comment));
        self::assertEquals(new ArrayCollection(array()), $book->getComments());
